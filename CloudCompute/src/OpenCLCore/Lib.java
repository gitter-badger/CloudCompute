...
public class Lib {
    ...
    public static void init() throws IOException {
         src_vsp = IOUtils.readText(Lib.class.getResource("kernels/vectorscalarproduct.cl"));
         program_vsp = context.createProgram(src_vsp);
         src_pr = IOUtils.readText(Lib.class.getResource("kernels/primorialresidue.cl"));
